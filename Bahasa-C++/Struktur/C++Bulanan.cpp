...
int main()
{
    ...
    cout<<"========================"<<endl;
    float ub,um,ut,uj,pengeluaran,mingguan,hasilA,hasilB,hasil;
    ub=1000000;
    ...
    if (angka==1)
    {
        ...
        pengeluaran=uj;
        mingguan=um;
        hasilA=pengeluaran < mingguan;
        cout<<"kesimpulan dari pengeluaran < mingguan: "<<hasilA<<endl;
    }
    else if (angka==2)
        {
            ...
            pengeluaran=uj;
            mingguan=um;
            hasilB=pengeluaran < mingguan;
            cout<<"kesimpulan dari pengeluaran < mingguan: "<<hasilB<<endl;
        }
    else {
    cout<<"pilihan yang anda masukkan salah"<<endl;
    }
    cout<<"jika hasil 1 dan 2 benar maka: "<<endl;
    hasil=hasilA && hasilB;
    cout<<"hasil A & hasil B: "<<hasil<<endl;
